...
My primary research interests include psycholinguistics, variationist sociolinguistics, and second language acquisition (SLA) across the lifespan, especially as concerns quantitative approaches, statistical methods, and novel approaches to data collection, for example virtual reality as an elicitation instrument to reconcile ecological validity and experimental control. In my work on SLA, I am interested in the role of psychosocial, linguistic, and cognitive factors on the acquisition of sociolinguistic variation in L2 learning, and how socioaffective, experiential, and contextual variables impact additional language learning. My habilitation project merges psycho- and sociolinguistic approaches in order to investigate how major life events (e.g., entry into the workforce, parenthood, romantic relationships) affect language variation and change across the lifespan in the first and second language. 
...
- Forensic linguistics in the context of multilingualism, particularly eyewitness testimonies in the second language
